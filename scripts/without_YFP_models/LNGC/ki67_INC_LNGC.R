...
## model files (Stan)
modelName <- "ki67_INC_LNGC"        # name of the file for stan model 
#### in some cases name of the stan file is depedent on the name of the precursor pop used

## Setting all the directories for opeartions
projectDir <- getwd()
scriptDir <- file.path(projectDir, "scripts", "without_YFP_models", "LNGC")
modelDir <- file.path(projectDir, "models", "without_YFP_models", "LNGC")
dataDir <- file.path(projectDir, "data")
toolsDir <- file.path(scriptDir, "tools")
outputDir <- file.path(projectDir, "output", "without_YFP_models", "LNGC")
