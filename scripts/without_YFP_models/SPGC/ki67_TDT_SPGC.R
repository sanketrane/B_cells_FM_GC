## Time dependent turnover -- Homogeneous model 
...
## model files (Stan)
modelName <- "ki67_TDT_SPGC"        # name of the file for stan model 
...
init <- function() list(
  ...
  delta0 = exp(rnorm(1,log(0.01), 0.01)),
  r_d = exp(rnorm(1, log(0.005), 0.1)),
