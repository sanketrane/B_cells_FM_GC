...
## model files (Stan)
modelName <- "ki67_TDD_SPGC"        # name of the file for stan model 
...
init <- function() list(
  ...
  delta = exp(rnorm(1,log(1), 0.01)),
  rho0 = exp(rnorm(1, log(1), 0.01)),
  r_d = exp(rnorm(1, log(0.005), 0.01)),
...
parametersToPlot <- c("psi", "delta", "r_d", "rho0", "Beta",  "y0_Log", "kappa_0",
