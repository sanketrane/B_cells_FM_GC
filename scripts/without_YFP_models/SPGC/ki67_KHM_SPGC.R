...
## model files (Stan)
modelName <- "ki67_KHM_SPGC"        # name of the file for stan model 
...
init <- function() list(
  ...
  rhoFast = exp(rnorm(1,log(0.05), 0.5)),
  rhoSlow = exp(rnorm(1,log(0.001), 0.5)),
  lambdaSlow = exp(rnorm(1, log(0.001), 0.01)),
  lambdaFast = exp(rnorm(1, log(0.1), 0.01)),
