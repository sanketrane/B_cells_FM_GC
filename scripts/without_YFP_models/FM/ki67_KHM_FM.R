## Kinetic heterogeneity model -- heterogeneous model 
...
## model files (Stan)
modelName <- "ki67_KHM_FM"        # name of the file for stan model 
...
init <- function() list(
  psi = exp(rnorm(1, log(0.05), 0.1)),
  f_fast = exp(rnorm(1, log(0.1), 0.1)),
  Beta = exp(rnorm(1,log(3.5), 0.1)),
  rhoFast = exp(rnorm(1,log(0.01), 0.1)),
  rhoSlow = exp(rnorm(1,log(0.001), 0.1)),
  lambdaSlow = exp(rnorm(1,log(0.001), 0.1)),
  lambdaFast = exp(rnorm(1,log(0.03), 0.1)),
  alpha = exp(rnorm(1, log(0.1), 0.1)),
  
  y0_Log = rnorm(1, 16 , 0.01),
  kappaF_0 = exp(rnorm(1, log(0.4), 0.1)),
  kappaS_0 = exp(rnorm(1, log(0.2), 0.1)),
