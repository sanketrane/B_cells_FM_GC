## constant birth and death rate model -- Homogeneous model 
...
## model files (Stan)
modelName <- "ki67_SHM_FM"        # name of the file for stan model 
...
parametersToPlot <- c("psi", "rho", "delta", "Beta", "y0_Log", "kappa_0",
...
otherRVs <- c("y1_mean_pred_age1", "countspred_age1", "y1_mean_pred_age2", "countspred_age2", "y1_mean_pred_age3", "countspred_age3",
              ...
              "lambda_inv", "rho_inv", "lambda", "delta_inv",
