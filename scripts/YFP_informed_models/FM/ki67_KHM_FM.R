...
init <- function() list(
  ...
  lambdaFast = exp(rnorm(1,log(0.05), 0.01)),
  deltaYFP = exp(rnorm(1,log(0.2), 0.01)),
...
parametersToPlot <- c("psi", "f_fast", "rhoFast", "rhoSlow", "lambdaSlow", "lambdaFast", "deltaYFP",  "alpha_calc",
