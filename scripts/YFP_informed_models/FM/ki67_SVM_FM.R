...
seed <- 4010 + i                     ### Use your lucky mumber! haha! 
...
init <- function() list(
  ...
  deltaYFP = exp(rnorm(1, log(0.3), 0.01)),
  r_psi = exp(rnorm(1, log(0.0001), 0.1)),
...
parametersToPlot <- c("psi", "rho", "deltaYFP", "r_psi",  "Beta", "y0_Log", "kappa_0",
...
otherRVs <- c("y1_mean_pred_age1", "countspred_age1", "y1_mean_pred_age2", "countspred_age2", "y1_mean_pred_age3", "countspred_age3",
             ...
             "lambda_calc",  "lambda_inv", "rho_inv", "delta", "delta_inv")
