...
init <- function() list(
  ...
  lambda = exp(rnorm(1,log(0.08), 0.01)),
  rho_inc = exp(rnorm(1,log(1), 0.5)),
...
parametersToPlot <- c("psi", "delta", "rho", "lambda", "rho_inc",  "Beta",
...
otherRVs <- c("y1_mean_pred_age1", "countspred_age1", "y1_mean_pred_age2", "countspred_age2", "y1_mean_pred_age3", "countspred_age3",
              ...
              "lambda_inv", "rho_inv", "delta", "delta_inv", "rhoInc_inv",
