functions{
  real theta_spline(real t,
   ...
   y1 = log(counts);                                // transforming cell counts to feed in to ODEs
   y2 = logit_boundary_array(Nfd);                  // logit transformed  donor fractions normalised to source chimerism to feed in to ODEs
