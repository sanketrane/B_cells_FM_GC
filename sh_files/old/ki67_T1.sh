...
srun -N 1 --ntasks=1 --ntasks-per-node=1 Rscript --vanilla scripts/ki67_SHM_LNGC.R "T1_data.csv" &
...
srun -N 1 --ntasks=1 --ntasks-per-node=1 Rscript --vanilla scripts/ki67_INC_LNGC.R "T1_data.csv" &
wait
